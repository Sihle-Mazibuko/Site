...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm("service_znd7cfn", "template_16vdf2j", form.current, {
      publicKey: "JyPH4waB8Z7gfS70o",
    });
    e.target.reset();
  };
        ...
        <div className="contact-content">
          ...
          <div className="contact-info">
            ...
            <div className="contact-card">
              <i className="bx uil-envelope contact-card-icon"></i>
            ...
            {/* Whatsapp */}
            <div className="contact-card">
              <i className="bx uil-whatsapp contact-card-icon"></i>

              <h3 className="contact-card-title">Whatsapp</h3>
              <span className="contact-card-data">(+27)-83-989-0907</span>

              <a href="https://wa.link/jb3ln6" className="contact-button">
                Write to me
                <i className="bx uil-arrow-right contact-button-icon"></i>
              </a>
            </div>
            {/* instagram */}
            <div className="contact-card">
              <i className="bx uil-instagram contact-card-icon"></i>
